...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'konjac0629@windsyouth.com',
  ...
  title: "Konjac Blog | 文件",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/KonjacBlog_Files',
  ...
  email: 'mailto:konjac0629@windsyouth.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/Konjac0629',
    },
  ],
